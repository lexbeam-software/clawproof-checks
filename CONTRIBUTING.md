...
Open an issue. For private disclosure (e.g., incident reports you don't want public yet), use the contact address on the Impressum at [www.goclawproof.com/impressum](https://www.goclawproof.com/impressum).
